    ...
    return (
        <div className="flex flex-col overflow-x-hidden">
            ...
            <header className="flex flex-col sm:flex-row h-screen w-full justify-center items-center gap-4 mt-16">
                <div className="flex flex-col gap-2 w-full">
                    ...
                    >
                        ...
                        <h4 className="scroll-m-20 text-lg font-semibold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
                            Current work at{' '}
                            <Link
                                href="https://tienphongcorp.com/"
                                target="_blank"
                                passHref
                            >
                                <Button
                                    variant="link"
                                    className="text-neutral-400 px-0 text-lg font-semibold tracking-tight"
                                >
                    ...
                    >
                        <p className="leading-7">
                            As a developer and lifelong learner, I'm passionate
                            about coding, reading, and creating valuable digital
                            products.
                        </p>
                    </Reveal>
            ...
            <section className="flex flex-col items-start justify-start gap-4 sm:py-32 py-16">
                ...
                >
                    <p className="leading-7">
                        I'm a person who loves making stuff, especially things
                        you can see and interact. Back when I was 13, I got into
                        creating custom game maps for Warcraft III Frozen
                        Throne, making videos with Sony Vegas, and cooking up
                        tunes with FL Studio. Then in 2018, during my foundation
                        year, I stumbled upon programming and got hooked on web
                        development. Haven't looked back since.
                        <br />
                        <br />
                        Fast-forward to today, I've successfully earned my
                        Software Engineering degree from Universiti Malaya.
                        Along the way, I had the privilege of contributing to
                        software development for a startup in Malaysia and
                        engaging in an internal project for the company I
                        interned at. Not to mention the countless hours spent on
                        personal projects and hackathons.
                        <br />
                        <br />
                        Presently, my primary focus revolves around mastering
                        the art of building high-quality and scalable software
                        ...
                        <br />
                        <br />
                        When I'm not coding, I usually play games, read books
                        (my fav is novel) or binge-watch Youtube videos.
                    </p>
                </Reveal>
            </section>
            <Separator />
