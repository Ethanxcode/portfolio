...
import { AtSign, ExternalLink, Github, Gitlab, Linkedin } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col overflow-x-hidden">
      {/* Hero */}
      <header className="mt-16 flex h-screen w-full flex-col items-center justify-center gap-4 sm:flex-row">
        <div className="flex w-full flex-col gap-2">
          ...
          >
            <h3 className="scroll-m-20 bg-opacity-50 bg-gradient-to-b from-neutral-50 to-neutral-400 bg-clip-text text-2xl font-semibold tracking-tight text-transparent">
              Software Engineer
            </h3>
            <h4 className="scroll-m-20 bg-opacity-50 bg-gradient-to-b from-neutral-50 to-neutral-400 bg-clip-text text-lg font-semibold tracking-tight text-transparent">
              Current work at{' '}
              <Link href="https://tienphongcorp.com/" target="_blank" passHref>
                <Button
                  variant="link"
                  className="px-0 text-lg font-semibold tracking-tight text-neutral-400"
                >
                  TIEN PHONG CDS JOINT STOCK COMPANY
          ...
          >
            <p className="leading-7">
              As a developer and lifelong learner, I'm passionate about coding,
              reading, and creating valuable digital products.
            </p>
          </Reveal>
            ...
            <TooltipProvider>
              ...
              >
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link
                      href="https://gitlab.com/trannguyendanhuy2904"
                      target="_blank"
                    >
                      <Button variant="secondary" size="icon">
                        <Gitlab />
      ...
      <section className="flex flex-col items-start justify-start gap-4 py-16 sm:py-32">
        ...
        >
          <p className="leading-7">
            I'm a person who loves making stuff, especially things you can see
            and interact. Back when I was 13, I got into creating custom game
            maps for Warcraft III Frozen Throne, making videos with Sony Vegas,
            and cooking up tunes with FL Studio. Then in 2018, during my
            foundation year, I stumbled upon programming and got hooked on web
            development. Haven't looked back since.
            <br />
            <br />
            Fast-forward to today, I've successfully earned my Software
            Engineering degree from Universiti Malaya. Along the way, I had the
            privilege of contributing to software development for a startup in
            Malaysia and engaging in an internal project for the company I
            interned at. Not to mention the countless hours spent on personal
            projects and hackathons.
            <br />
            <br />
            Presently, my primary focus revolves around mastering the art of
            building high-quality and scalable software applications,
            continuously refining my skills in both frontend and backend
            development. As the saying goes,{' '}
            <em>"Once you go fullstack, you never go back"</em>.
            <br />
            <br />
            When I'm not coding, I usually play games, read books (my fav is
            novel) or binge-watch Youtube videos.
          </p>
        </Reveal>
      </section>
      <Separator />
      ...
      <section
        id="contact"
        className="flex flex-col items-center justify-center gap-4 py-24 sm:py-48"
      >
        <h2 className="scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-4xl">
          Get In Touch
        </h2>
